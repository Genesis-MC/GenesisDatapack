...
execute anchored eyes positioned ^ ^-1 ^1 as @e[distance=..1.5,tag=!gen.ally,type=#gen:alive] run damage @s 5 player_explosion
execute anchored eyes positioned ^ ^-1 ^3 as @e[distance=..1.5,tag=!gen.ally,type=#gen:alive] run damage @s 5 player_explosion
execute anchored eyes positioned ^ ^-1 ^5 as @e[distance=..1.5,tag=!gen.ally,type=#gen:alive] run damage @s 5 player_explosion

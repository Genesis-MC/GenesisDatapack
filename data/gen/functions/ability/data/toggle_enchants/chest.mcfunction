...
execute if entity @s[nbt={Inventory:[{Slot:102b,tag:{HideFlags:195}}]}] run scoreboard players set #temp_for_toggling gen.temp 2
execute if entity @s[nbt={Inventory:[{Slot:102b,tag:{HideFlags:194}}]}] run scoreboard players set #temp_for_toggling gen.temp 3

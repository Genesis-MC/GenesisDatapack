...
execute store result storage gen:temp cooldown int 1 store result score @s gen.cooldown.main run scoreboard players operation #new gen.math += .gametime gen.time

...
data modify storage gen:crops to_register append value {id:"genesis:mycology/dark_shroom",growth:{time:{min:100,max:300},stages:5},display:{stages_per_model:1,models:{id:"minecraft:amethyst_cluster",custom_model_data_start:13}},seed_item:{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:mycology/dark_shroom"},genesis:{phead:{detect:1b}},gen:{mycology:{sunlight:0,hazard:35,growth_speed:50,growth_size:50,temperature:12,moisture:67,mutability:2}},CustomModelData:3,display:{Name:'{"text":"Dark Shroom","italic":false,"color":"#331199"}'}}},harvest:{loot_table:"minecraft:blocks/brown_mushroom",xp:1},bone_meal:{stages:{min:0,max:1}}}
data modify storage gen:crops to_register append value {id:"genesis:mycology/light_shroom",growth:{time:{min:100,max:300},stages:5},display:{stages_per_model:1,models:{id:"minecraft:decorated_pot",custom_model_data_start:13}},seed_item:{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:mycology/light_shroom"},genesis:{phead:{detect:1b}},gen:{mycology:{sunlight:100,hazard:56,growth_speed:50,growth_size:50,temperature:81,moisture:18,mutability:2}},CustomModelData:3,display:{Name:'{"text":"Light Shroom","italic":false,"color":"#55FFCC"}'}}},harvest:{loot_table:"minecraft:blocks/red_mushroom",xp:1},bone_meal:{stages:{min:0,max:1}}}

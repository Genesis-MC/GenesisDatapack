...
data modify storage gen:crops to_register append value {id:"genesis:foo",growth:{time:{min:200,max:300},stages:8},display:{stages_per_model:1,models:{id:"minecraft:sunflower",custom_model_data_start:1}},seed_item:{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:foo"},genesis:{phead:{detect:1b}},CustomModelData:1,display:{Name:'{"text":"Foo Seed"}'}}},harvest:{loot_table:"gen:crops/harvest/foo",xp:10},bone_meal:{stages:{min:1,max:2}}}

data modify storage gen:crops to_register append value {id:"genesis:bar",growth:{time:{min:400,max:600},stages:4},display:{stages_per_model:1,models:{id:"minecraft:sunflower",custom_model_data_start:9}},seed_item:{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:bar"},genesis:{phead:{detect:1b}},CustomModelData:2,display:{Name:'{"text":"Bar Seed"}'}}},harvest:{loot_table:"gen:crops/harvest/bar",xp:100},bone_meal:{stages:{min:0,max:1}}}

data modify storage gen:crops to_register append value {id:"genesis:heartbeet",growth:{time:{min:13500,max:18000},stages:5},display:{stages_per_model:1,models:{id:"minecraft:sunflower",custom_model_data_start:13}},seed_item:{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:heartbeet"},genesis:{phead:{detect:1b}},CustomModelData:3,display:{Name:'{"text":"Heartbeet Seed"}'}}},harvest:{loot_table:"gen:crops/harvest/heartbeet",xp:5},bone_meal:{stages:{min:0,max:1}}}
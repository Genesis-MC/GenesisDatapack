...
data modify storage gen:crops to_register append value {id:"genesis:foo",growth:{time:{min:200,max:300},stages:8},display:{stages_per_model:1,models:{id:"minecraft:sunflower",custom_model_data_start:1}},seed_item:{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:foo"},genesis:{phead:{detect:1b}},CustomModelData:1,display:{Name:'{"text":"Foo Seed","italic":false}'}}},harvest:{loot_table:"gen:crops/harvest/foo",xp:10},bone_meal:{stages:{min:1,max:3}}}

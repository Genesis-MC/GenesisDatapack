...
data modify storage gen:crops to_register append value {id:"genesis:corn",growth:{time:{min:13500,max:18000},stages:8},display:{stages_per_model:1,models:{id:"minecraft:sunflower",custom_model_data_start:18}},seed_item:{preprocessing:{show_growth_time:1b,apply_default_skin:1b},Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"genesis.block.crop.seed.genesis:corn"},genesis:{phead:{detect:1b}},CustomModelData:4,display:{Name:'{"text":"Corn Seed","italic":false}'}}},harvest:{loot_table:"gen:crops/harvest/corn",xp:5},bone_meal:{stages:{min:2,max:4}},requirements:{soil:["minecraft:farmland"]}}

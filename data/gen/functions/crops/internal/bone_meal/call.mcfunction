...
scoreboard players set #can_bonemeal gen.crops.calc 1
execute if score crops.bonemeal_harvest_and_replant gen.config matches 0 if score #age gen.crops.calc >= #max_age gen.crops.calc run scoreboard players set #can_bonemeal gen.crops.calc 0

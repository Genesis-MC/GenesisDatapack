execute unless data storage gen:core used_wfoas.tag.gen.on_click.dev{dev_stone:1b} run return 0
...
execute if data storage gen:temp to_modify[0] run function gen:dev/internal/modify_dev_stones_loop
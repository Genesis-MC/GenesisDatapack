...
# relic_power
scoreboard players operation @s gen.stat.relic_power -= @s gen.stat.relic_power.chest
execute store result score @s gen.stat.relic_power.chest run data get storage tungsten:player Item.tag.gen.stat.relic_power
scoreboard players operation @s gen.stat.relic_power += @s gen.stat.relic_power.chest
# mana_pool

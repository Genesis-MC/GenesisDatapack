...
# relic_power
scoreboard players operation @s gen.stat.relic_power -= @s gen.stat.relic_power.offhand
execute store result score @s gen.stat.relic_power.offhand run data get storage tungsten:player Item.tag.gen.stat.relic_power
scoreboard players operation @s gen.stat.relic_power += @s gen.stat.relic_power.offhand
# mana_pool

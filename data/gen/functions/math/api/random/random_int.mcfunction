#####################################################################
# math/api/random/random_int.mcfunction
# written by Eroxen
#
# Puts a random value between the negative and positive integer limit
# in the score #random.value gen.math
#####################################################################

scoreboard players set #random.value gen.math 0
execute if predicate gen:math/random run scoreboard players set #random.value gen.math -2147483648

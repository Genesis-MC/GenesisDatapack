execute store result score #Emeralds gen.temp run clear @a[tag=this,limit=1] minecraft:emerald 0
execute store result score #EmeraldBlocks gen.temp run clear @a[tag=this,limit=1] minecraft:emerald_block 0

...
execute at @e[tag=gen.mirage_prism] run particle totem_of_undying ~ ~0.5 ~ 0.3 0.6 0.3 0 6
...
execute at @e[tag=gen.charge.prismatic] run particle enchant ~ ~ ~ 0.1 0.1 0.1 0 5
execute at @e[tag=gen.charge.prismatic] run particle entity_effect ~ ~ ~ 0.1 0.1 0.1 0 2

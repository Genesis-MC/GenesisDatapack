data modify entity @s HandItems[].tag.gen.SavedMobName set value '{"translate":"genesis.mobs.demon.animation.6"}'
execute store result score #bossbars.value gen.temp run data get entity @s Health 0.750

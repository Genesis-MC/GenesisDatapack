...
data modify storage genesis:temp name set value ''
data modify storage genesis:temp name set from entity @s[tag=gen.mobs.name_in_mainhand] HandItems[0].tag.gen.SavedMobName
data modify storage genesis:temp name set from entity @s[tag=gen.mobs.name_in_offhand] HandItems[1].tag.gen.SavedMobName

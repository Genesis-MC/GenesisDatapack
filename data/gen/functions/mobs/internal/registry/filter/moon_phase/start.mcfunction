...
#tellraw @s {"nbt":"read[].requirements.moon_phase","storage": "gen:mobs","color":"blue"}
...
#tellraw @s {"nbt":"read[].requirements.moon_phase","storage": "gen:mobs","color":"yellow"}
...
#tellraw @s {"nbt":"read[].requirements.moon_phase","storage": "gen:mobs","color":"red"}

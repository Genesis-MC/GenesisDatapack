...
# 0 5 
execute store result score #min gen.temp run data get storage gen:mobs current_item.requirements.moon_phase.min
execute store result score #max gen.temp run data get storage gen:mobs current_item.requirements.moon_phase.max
...
execute store result score #exact gen.temp run data get storage gen:mobs current_item.requirements.moon_phase.exact

...
scoreboard players operation @s gen.profession.artificing.xp += #xp gen.professions
scoreboard players operation #required_xp gen.professions *= @s gen.profession.artificing.level
scoreboard players operation #lvl gen.professions = @s gen.profession.artificing.level
...
execute if score @s gen.profession.artificing.xp >= #required_xp gen.professions run function gen:professions/artificing/internal/levelup

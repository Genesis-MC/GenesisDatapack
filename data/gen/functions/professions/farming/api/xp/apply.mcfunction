...
scoreboard players operation @s gen.profession.farming.xp += #xp gen.professions
scoreboard players operation #required_xp gen.professions *= @s gen.profession.farming.level
scoreboard players operation #lvl gen.professions = @s gen.profession.farming.level
...
execute if score @s gen.profession.farming.xp >= #required_xp gen.professions run function gen:professions/farming/internal/levelup

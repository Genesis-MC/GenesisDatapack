...
execute at @s positioned ~-.1 ~.5 ~-.1 run kill @e[type=block_display,limit=2,sort=nearest]
...
execute if entity @s[tag=normCrystalarium] run loot spawn ~ ~ ~ loot gen:professions/mineralogy/crystal_node
execute if entity @s[tag=pureCrystalarium] run loot spawn ~ ~ ~ loot gen:professions/mineralogy/pure_crystal_node

...
execute align xyz run summon armor_stand ~.5 ~-1 ~.5 {Tags:["Crystalarium","normCrystalarium","Tier1"],NoGravity:1b,Invulnerable:1b,Invisible:0b,DisabledSlots:4079422,ShowArms:1b,CustomNameVisible:1b,CustomName:'{"text":"Tier 1","bold":true,"italic":false}'}
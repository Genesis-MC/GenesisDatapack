...
execute align xyz run summon armor_stand ~.5 ~-1 ~.5 {Tags:["Crystalarium","normCrystalarium","Tier1"],NoGravity:1b,Invulnerable:1b,Invisible:1b,ShowArms:1b,CustomNameVisible:1b,CustomName:'{"translate":"Tier 1","bold":true,"italic":false}',DisabledSlots:4079422}
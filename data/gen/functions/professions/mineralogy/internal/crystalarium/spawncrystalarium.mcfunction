...
execute align xyz run summon armor_stand ~.5 ~-1 ~.5 {Tags:["Crystalarium","normCrystalarium","T1Crystalarium"],NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:1b,DisabledSlots:4144959}
...
execute if entity @s[tag=Tier4,nbt={HandItems:[{tag:{gen:{name:"cerulean_enhancement_crystal"}}},{}]}] run data merge entity @s {HandItems:[{id:"minecraft:iron_nugget",Count:1b,tag:{gen:{EnhancementCrystal:0b}}},{}],CustomName:'{"translate":"Tier 5","bold":true,"italic":false}',DisabledSlots:4144959}
...
execute if entity @s[tag=Tier3,nbt={HandItems:[{tag:{gen:{name:"crimson_enhancement_crystal"}}},{}]}] run data merge entity @s {HandItems:[{id:"minecraft:iron_nugget",Count:1b,tag:{gen:{EnhancementCrystal:0b}}},{}],CustomName:'{"translate":"Tier 4","bold":true,"italic":false}'}
...
execute if entity @s[tag=Tier2,nbt={HandItems:[{tag:{gen:{name:"pink_enhancement_crystal"}}},{}]}] run data merge entity @s {HandItems:[{id:"minecraft:iron_nugget",Count:1b,tag:{gen:{EnhancementCrystal:0b}}},{}],CustomName:'{"translate":"Tier 3","bold":true,"italic":false}'}
...
execute if entity @s[tag=Tier1,nbt={HandItems:[{tag:{gen:{name:"yellow_enhancement_crystal"}}},{}]}] run data merge entity @s {HandItems:[{id:"minecraft:iron_nugget",Count:1b,tag:{gen:{EnhancementCrystal:0b}}},{}],CustomName:'{"translate":"Tier 2","bold":true,"italic":false}'}

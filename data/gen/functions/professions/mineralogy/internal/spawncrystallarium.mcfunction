...
#/function gen:professions/mineralogy/internal/spawncrystallarium

setblock ~ ~-1 ~ amethyst_block replace
...
execute align xyz run summon block_display ~.1 ~-.199 ~.1 {NoGravity:1b,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[.8f,.2f,.8f]},block_state:{Name:"minecraft:budding_amethyst"}}
#execute align xyz run summon armor_stand ~.5 ~-1 ~.5 {NoGravity:1b,Invulnerable:1b,Small:0b,Invisible:0b,DisabledSlots:4144959}
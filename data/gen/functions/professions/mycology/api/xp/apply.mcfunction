...
scoreboard players operation @s gen.profession.mycology.xp += #xp gen.professions
scoreboard players operation #required_xp gen.professions *= @s gen.profession.mycology.level
scoreboard players operation #lvl gen.professions = @s gen.profession.mycology.level
...
execute if score @s gen.profession.mycology.xp >= #required_xp gen.professions run function gen:professions/mycology/internal/levelup

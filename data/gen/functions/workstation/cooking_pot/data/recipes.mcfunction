...
#Fried Calamari
execute if data storage gen:workstation recipe.output{ingredients:2,items:[{id:"minecraft:tropical_fish",Count:1,tag:{gen:{name:"Calimari"}}},{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Cornstarch"}}}]} run data modify storage gen:workstation cooking_pot.current_recipe set value {loot_table:"gen:food/fried_calamari",time:50}
#Prime Rib
execute if data storage gen:workstation recipe.output{ingredients:2,items:[{id:"minecraft:beef",Count:1,tag:{gen:{name:"Prime Beef"}}},{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Salt"}}}]} run data modify storage gen:workstation cooking_pot.current_recipe set value {loot_table:"gen:food/prime_rib",time:100}
#Borscht
execute if data storage gen:workstation recipe.output{ingredients:5,items:[{id:"minecraft:bowl",Count:1},{id:"minecraft:potato",Count:1},{id:"minecraft:beetroot",Count:1},{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Salt"}}},{id:"minecraft:tropical_fish",Count:1,tag:{gen:{name:"Heartbeet"}}}]} run data modify storage gen:workstation cooking_pot.current_recipe set value {loot_table:"gen:food/borscht",time:300}
#Stew of the Sea
...
#Melon Candy
execute if data storage gen:workstation recipe.output{ingredients:3,items:[{id:"minecraft:melon_slice",Count:1},{id:"minecraft:sugar",Count:1},{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Cornstarch"}}}]} run data modify storage gen:workstation cooking_pot.current_recipe set value {loot_table:"gen:food/melon_candy",time:50}
#Sakura Candy
execute if data storage gen:workstation recipe.output{ingredients:4,items:[{id:"minecraft:pink_petals",Count:1},{id:"minecraft:sugar",Count:1},{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Cornstarch"}}},{id:"minecraft:honey_bottle",Count:1,tag:{gen:{name:"Floral Nectar"}}}]} run data modify storage gen:workstation cooking_pot.current_recipe set value {loot_table:"gen:food/sakura_candy",time:50}
#Prismatic Candy
execute if data storage gen:workstation recipe.output{ingredients:3,items:[{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Cornstarch"}}},{id:"minecraft:sugar",Count:1},{id:"minecraft:iron_nugget",Count:1,tag:{gen:{name:"Pure Crystal"}}}]} run data modify storage gen:workstation cooking_pot.current_recipe set value {loot_table:"gen:food/prismatic_candy",time:50}
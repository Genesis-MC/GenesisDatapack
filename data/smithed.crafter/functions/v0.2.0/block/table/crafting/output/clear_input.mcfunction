...
execute if data storage smithed.crafter:input {recipe:[{id:"minecraft:wooden_axe",Count:1b,tag:{gen:{name:"Novice's Mallet"}}}]} run scoreboard players set @s gen.temp 1
execute if data storage smithed.crafter:input {recipe:[{id:"minecraft:wooden_axe",Count:1b,tag:{gen:{name:"Apprentice's Mallet"}}}]} run scoreboard players set @s gen.temp 2
execute if data storage smithed.crafter:input {recipe:[{id:"minecraft:wooden_axe",Count:1b,tag:{gen:{name:"Journeyman's Mallet"}}}]} run scoreboard players set @s gen.temp 3
execute if data storage smithed.crafter:input {recipe:[{id:"minecraft:wooden_axe",Count:1b,tag:{gen:{name:"Expert's Mallet"}}}]} run scoreboard players set @s gen.temp 4
execute if data storage smithed.crafter:input {recipe:[{id:"minecraft:wooden_axe",Count:1b,tag:{gen:{name:"Master's Mallet"}}}]} run scoreboard players set @s gen.temp 5

...
execute store result score .new tungsten.uid.offhand run attribute @s minecraft:generic.luck modifier value get 0000000c-0000-a455-0000-00000000000b 1000000000000.5
